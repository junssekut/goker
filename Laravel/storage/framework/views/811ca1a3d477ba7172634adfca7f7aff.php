<footer class="bg-gray-900 text-white py-6 w-full">
    <div class="container w-full pl-6 md:px-44">
        <!-- Div 1: Logo -->
        <div class="flex justify-start flex-col gap-y-[19px]">
            <!-- Logo -->
            <div class="flex">
                <img src="<?php echo e(asset('assets/images/goker-gelap.png')); ?>" alt="Goker Logo"
...
<?php /**PATH C:\Kodingan\Laravel\gokerBaruBanget\goker\Laravel\resources\views/components/footer.blade.php ENDPATH**/ ?>