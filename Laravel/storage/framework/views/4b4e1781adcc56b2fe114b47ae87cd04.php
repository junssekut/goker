...
<!--[if BLOCK]><![endif]--><?php if($messages): ?>
    <ul x-data="{ show: false }" x-transition <?php echo e($attributes->merge(['class' => 'text-sm text-red-600 pt-2'])); ?>
...
<?php /**PATH C:\Kodingan\Laravel\gokerBaruBanget\goker\Laravel\resources\views/components/input-error.blade.php ENDPATH**/ ?>