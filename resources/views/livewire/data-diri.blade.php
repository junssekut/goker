...
{
    public $name, $panggilan, $lahir, $kelamin, $domisili;

    protected $rules = [
        'name' => 'required|min:3',
        'panggilan' => 'required|min:3',
        'lahir' => 'required|date_format:Y-m-d',
        'kelamin' => 'required',
    ...
    {
        dump($this->name, $this->panggilan, $this->lahir, $this->kelamin, $this->domisili);
        $this->validate(); // Validasi data
        $this->emit('formValidated'); // Emit event jika validasi lolos
    }
}
?>
...
<div>
    <form
        ...
        <div id="form1" class="flex flex-col gap-2 relative z-10">
            <div class="font-britHeavy text-[23px] text-white flex px-7 h-auto pt-8 pb-2 justify-center items-center">
                <p> Dua langkah menuju Gokers sejati </p>
            </div>

            <div class="input-box">
                <div class="font-mnbold text-[12px] text-white flex w-full h-auto items-center pl-[35px] pb-1">
            ...
            <div class="input-box">
                <div class="font-mnbold text-[12px] text-white flex w-full h-auto items-center pl-[35px] pb-1 pt-1">
            ...
            <div>
                <div class="font-mnbold text-[12px] text-white flex w-full h-auto items-center pl-[35px] pt-1">
        ...
        <div id="form2" class="hidden flex-col relative z-10 gap-2">
            <div class="font-britHeavy text-[24px] text-white flex px-8 h-auto pt-8 pb-3 justify-center items-center">
            ...
            <div class="input-box">
                ...
                <div class="font-mnbold text-[12px] flex w-full h-auto justify-center">
                    <input type="text" wire:model.live="sekolah" name="sekolah"
                        ...
                        placeholder="Gokers terakhir sekolah dimana nih?" required minlength="3" maxlength="50">
                </div>
