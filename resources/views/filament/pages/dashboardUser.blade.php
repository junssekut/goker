<x-filament::page>
    ...
    <div class="flex flex-col gap-y-0">
        ...
        <div class="flex flex-row justify-start items-center p-3 rounded-xl shadow-lg text-white"
            ...
            <div class="flex flex-col gap-2">
                <h1 class="text-3xl font-semibold">Histori Lamaran Kamu</h1>
                <p class="text-md w-11/12 line-clamp-3">Hei Gokers <span
                        class="font-semibold">{{ Auth::user()->name }}</span> Yuk dicek hasil lamaran kamu. Semoga
                    keterima yah!</p>
            </div>
        ...
        <div class="">
            ...
            @livewire(App\Filament\User\Resources\CareerDetailResource\Pages\ListCareerDetails::class)
